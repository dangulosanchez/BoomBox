 ...
 * Static CyberLunaWindow instances (non-draggable, in-flow).
 */
const Contact = () => {
    return (
                ...
                <div className={styles.container}>
                    <div className={styles.layout}>
                        ...
                        <aside className={styles.infoPanel}>
                            <CyberLunaWindow isStatic title={contact.info_window.title}>
                        ...
                        <div className={styles.formPanel}>
                            <CyberLunaWindow isStatic title={contact.form_window.title}>
                                <ContactForm />
                            </CyberLunaWindow>
                        </div>
